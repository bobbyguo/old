  ...
  <body>
  	<div id="content" align="center">
  		...
  		<s:form id="userForm" name="userForm" theme="simple">
  						...
  						<tbody>
  							...
  							<tr>
  								...
  								<td class="TableData">
  									...
  									<!--<s:radio id="isSys" name="user.isSys" list="#{'1':'是','0':'否'}" listKey="key" listValue="value" value="0" label="IsSys" required="true" requiredposition="right" />-->
  								</td>
  							</tr>
  							<tr>
  								<td class="TableLabel" width="35%">对应员工:</td>
  								<td class="TableData">
  									<s:textfield id="employeeName" name="employeeName" label="EmployeeName" readonly="true" /><img src="${ctx}/img/png-0023.png" height="18px" align="middle" width="18px" onclick="openWindow();" /><font color="red">非系统管理员请选择对应员工!</font>
  			...
  			<br/>
  			<s:submit id="save" name="save" value="保存" cssClass="BigButton" onclick="saveItem();" />
  		</s:form>
  	</div>
  </body>
</html>
